...
async def main():
    ...
    print("Adapted for 12-channel HEX data format")
    print("Expected format: 800,801,802,803,400,401,402,403,C00,C01,C02,C03")
    print("Each line = 12 hex values (3 devices × 4 channels)")
    print("30% more efficient than decimal format")
